...
- **Performance Improvements**
  - **[ChatGPT]** Optimized background network monitoring by ignoring unrelated site traffic, reducing CPU and memory overhead during chat sessions.

## [1.2.2] - 2026-05-08
- **Bug Fixes**
  - **[Core]** Fixed a bug where the fixed navigation console would stop following the input area after generating an image or triggering certain UI state changes. The tracking system now correctly handles temporary hidden input areas generated by the site's framework.
...
- **Bug Fixes**
  ...
  - Improved the overall stability of the theme editor's live preview by preventing rare crashes that could happen immediately after the settings window is closed.

## [1.0.0-b562] - 2026-03-20
- **Core Changes**
  - Optimized the internal event definitions using a centralized prefix generator, reducing boilerplate code and improving maintainability.

## [1.0.0-b561] - 2026-03-20
- **Core Changes**
  - Optimized the internal initialization of default settings, reducing the overall script file size and improving structural stability.

## [1.0.0-b560] - 2026-03-20
- **Core Changes**
  - Refactored internal style definitions to remove redundant code, improving maintainability and slightly reducing the overall script file size.

## [1.0.0-b559] - 2026-03-19
- **Core Changes**
  - Refactored internal CSS class and variable definitions to improve codebase maintainability and slightly reduce the overall script size.

## [1.0.0-b558] - 2026-03-19
- **Core Changes**
  - Optimized internal stylesheets to reduce the overall script file size by approximately 16KB, improving load times and resource efficiency.
...
- **Bug Fixes & Improvements**
  ...
  - Fixed edge-case bugs that could cause the Jump List UI to freeze, disappear, or behave erratically during rapid scrolling or initial loading.

## [1.0.0-b554] - 2026-03-18
- **Performance Improvements**
  - Migrated the underlying settings storage mechanism to an asynchronous API.
  - Improved overall UI responsiveness and eliminated brief browser freezes that could occur when loading or saving configuration changes.
...
## [1.0.0-b551] - 2026-03-17
- **Core Changes**
  - Refactored the internal CSS generation engine to use Dependency Injection. This decouples the style templates from global platform states and strictly enforces explicit data handling, further improving overall code maintainability and preventing silent rendering bugs.
...
## [1.0.0-b548] - 2026-03-17
- **Core Changes**
  - Resolved an internal type inference issue regarding platform detection to improve code stability and strict type-checking (`ts-check`) compatibility. This structural update does not alter the script's runtime behavior.

## [1.0.0-b547] - 2026-03-17
- **Bug Fixes**
  - Fixed a critical issue introduced in version `1.0.0-b542` that caused the script to crash when navigating between different chats or pages.
...
- **Core Changes**
  ...
  - Enhanced internal type safety and error handling mechanisms to prevent potential hidden runtime bugs and improve overall script stability.
...
- **Core Changes**
  ...
  - Removed legacy fallback code to improve overall script efficiency and maintainability.
...
## [1.0.0-b535] - 2026-03-17
- **Internal Improvements**
  - Improved internal type definitions to enforce stricter type safety and code reliability during the application startup sequence.
...
- **Performance Improvements**
  ...
  - Optimized the internal rendering process to ensure smoother scrolling and improved overall application responsiveness.

## [1.0.0-b532] - 2026-03-14
- **Performance Improvements**
  - Optimized the Color Picker in the Theme Editor to reduce processing overhead. Standard color inputs (such as HEX codes and `transparent`) are now applied instantly without causing layout thrashing, resulting in a smoother UI experience while fully maintaining the reliability and safety of complex color parsing.
...
- **Bug Fixes & Improvements**
  ...
  - Improved the stability of the observation engine by ensuring that an error in one component's listener does not disrupt the functionality of other components.
...
## [1.0.0-b508] - 2026-03-02
- **Performance & Fixes**
  - **[Core]** Hardened internal state management to prevent occasional silent UI freezes. The extension can now automatically recover from unexpected page layout errors without requiring a manual reload, greatly improving long-term stability and resilience.
...
- **Bug Fixes & Improvements**
  ...
  - **[ChatGPT]** Themes now update instantly when a chat is renamed in the sidebar, without requiring a page reload.
...
- **Improvements**
  - **[ChatGPT]** Improved the visual alignment of **Toast notifications**, ensuring they are now perfectly centered relative to the input form.

## [1.0.0-b484] - 2026-02-13
- **Fixes & Improvements**
  - **Auto-Recovery System**: Fixed an issue where avatars and navigation controls would disappear after leaving the tab inactive or during long chat sessions.
  - **Smart Self-Healing**: The extension now automatically detects if the chat interface has become desynchronized (e.g., due to browser memory saving or page updates) and repairs itself instantly without needing a reload.
  - **Active Monitoring**: Added a heartbeat mechanism that continuously ensures the interface remains stable even while you are actively using the chat or scrolling through long history.
