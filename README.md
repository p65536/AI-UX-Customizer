...
### 2026-01-21
- Updated `AI UX Customizer` (b329 -> b395)
- Updated `Gemini UX Customizer` (2.3.1 -> 2.4.0)

### 2026-01-17
- Updated `AI UX Customizer` (b321 -> b329)

### 2026-01-16
- Updated `AI UX Customizer` (b319 -> b321)

### 2026-01-15
- Updated `AI UX Customizer` (b303 -> b319)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **ChatGPT** & **Gemini** | [![Download](https://img.shields.io/badge/Download-blue?style=flat-square&logo=download)](https://raw.githubusercontent.com/p65536/AI-UX-Customizer/main/scripts/AI-UX-Customizer/AI-UX-Customizer.user.js) | (N/A in beta) | 1.0.0-b395 | 2026-01-21 | [View](./docs/AI-UX-Customizer/CHANGELOG_AIUXC.md) |
