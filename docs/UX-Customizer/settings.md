...
| **[GPTUX only]**<br>**Auto collapse user message** | **[ChatGPT only]**<br>Automatically collapses user messages that exceed the height threshold upon loading.<br>Requires **Collapsible button** to be enabled. |
